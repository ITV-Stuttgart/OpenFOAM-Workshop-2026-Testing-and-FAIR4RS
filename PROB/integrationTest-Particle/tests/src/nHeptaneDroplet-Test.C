...
TEST_CASE("nHeptaneDroplet","[serial]")
{
    ...
    // Time Loop
        ...
        // Generate a std::vector to store the results for further
        // post-processing
        ...
        // ==> TODO:
        // Write a for loop from 0 to 5 seconds that terminates once the
        // droplet is deleted, e.g., if td.keepParticle == false
